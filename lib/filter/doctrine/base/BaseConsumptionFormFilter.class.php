...
abstract class BaseConsumptionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'cns_cup_id'     => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'cns_username'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      'cns_cup_id'     => new sfValidatorPass(array('required' => false)),
      'cns_username'   => new sfValidatorPass(array('required' => false)),
